...
@interface StatesVCPA ()<UITableViewDataSource, UITableViewDelegate,CMIndexBarDelegate>
{
...
- (void)viewDidLoad
{
    ...
    if ([Common isIOS7]) {
        indexBar = [[CMIndexBar alloc] initWithFrame:CGRectMake(self.view.frame.size.width-80, 90.0, 80.0, self.view.frame.size.height-240)];
        indexBar.textColor = [UIColor colorWithRed:0.0 green:122.0/255.0 blue:1.0 alpha:1.0];
    }
    else
    {
        indexBar = [[CMIndexBar alloc] initWithFrame:CGRectMake(self.view.frame.size.width-80, 60.0, 80.0, self.view.frame.size.height-200)];
    }
